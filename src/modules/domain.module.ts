...
@Module({
  imports: [AdminModule, PermissionsModule, SubjectsModule, QuestionModule, TopicsModule, QuizModule, UserPermissionModule, SkillRatingModule, AppNotificationModule],
})
