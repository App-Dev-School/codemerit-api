...
@Module({
  imports: [TypeOrmModule.forFeature([User, JobRole, UserJobRole, Subject, JobRoleSubject, Topic, UserSubject, UserPermission, SubjectTrack, CertificationTrack]), UserPermissionModule],
